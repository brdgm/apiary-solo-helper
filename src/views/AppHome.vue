<template>
  ...
  <div class="float-end m-2 w-25">
    <a href="https://boardgamegeek.com/boardgame/400314/apiary" target="_blank" rel="noopener">
      <img src="../assets/game-apiary.webp" class="rounded shadow w-100 mb-3" alt=""/>
    </a>
  </div>
  ...
  <p class="text-muted fst-italic">
    {{t('home.feedback')}}
    <a href="https://boardgamegeek.com/thread/3357879/brdgmme-apiary-solo-helper-web-application" target="_blank" rel="noopener">Board Game Geek Thread</a> |
    <a href="https://github.com/brdgm/apiary-solo-helper" target="_blank" rel="noopener">GitHub</a>
  </p>
  ...
  <p class="disclaimer">
    ...
    All art in this app is from <a href="https://stonemaiergames.com/games/apiary/" target="_blank" rel="noopener">Apiary</a>.
